...
struct avl_tree_t {
    ...
    AvlTreeErrCode (*find)(AvlTree *this, void *item, AvlTreeNode *itemNode);

    AvlTreeErrCode (*next)(AvlTree *this, AvlTreeNode *node, AvlTreeNode *nextNode);

    AvlTreeErrCode (*insert)(AvlTree *this, void *item, AvlTreeNode *newNode);
